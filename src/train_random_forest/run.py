...
def go(args):
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Serialized model instance as Mlflow model",
        metadata={**rf_config, **{"max_tfidf_features":  args.max_tfidf_features, "random_state" : args.random_seed}}
    )
    artifact.add_dir(PATH_MODEL)
